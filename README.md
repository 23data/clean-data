...
> Note: This data set is in Wide Format. The wide format is more compact than the long format . The wide format makes it very easy to visually inspect the data as it is grouped by activity, subject, and the corresponding  mean of each remaining measurement. The wide format is deemed to be a tidy data format.(180 observations and 62 variables)
