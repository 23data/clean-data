...
> The *average/mean* for the activity "walking" by subject 2 for the feature / variable "timedomainbodyaccelerometerstdx" (Standard Deviation of Body acceleration by time on the X axis)
...
* Example: `t` becomes `timedomain` 

* Example: `f` becomes `freqdomain` 

* Example: `Acc` becomes `accelerometer` 

* Example: `Mag` becomes `magnitude` 

* "tBodyAccmean-X"  becomes "timedomainbodyaccelerometermeanx "
  
* "tBodyGyromean-Z' becomes "timedomainbodygyroscopemeanz"  
